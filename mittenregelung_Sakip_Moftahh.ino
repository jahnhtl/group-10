...
float changeToCentimeters(int sensorValue);
...
void loop() {
  ...
  /*  // Umwandlung der Infrarotwerte in Zentimeter
    float distanceLeft = changeToCentimeters(infraredValueLeft);
    float distanceCenter = changeToCentimeters(infraredValueCenter);
    float distanceRight = changeToCentimeters(infraredValueRight);
*/
...
void drive(int mode, int speed_one, int speed_two){
 ...
 /* Umrechnung der Sensorwert in Zentimeter
  float distance = A * exp(B * sensorValue) + C;
